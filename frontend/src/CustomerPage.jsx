    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Selamat Datang, {user?.full_name || user?.email || "Customer"}
          </h2>
          <p
            style={{
              margin: "0 0 24px 0",
          ...
          >
            Ini adalah halaman Customer Portal Anda
          </p>
          <div
            style={{
              marginTop: "32px",
          ...
          >
            <h3 style={{ margin: "0 0 8px 0", color: "#166534" }}>Customer Portal</h3>
            <p style={{ margin: "0", color: "#166534" }}>
              Anda dapat melihat pesanan, faktur, dan dokumen Anda di sini.
            </p>
          </div>
        </div>
      </div>
